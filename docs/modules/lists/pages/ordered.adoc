...
Define a new class selector (e.g., `.custom`) in your stylesheet that sets the https://developer.mozilla.org/en-US/docs/Web/CSS/list-style-type[`list-style-type`] property to the value of your choice.
